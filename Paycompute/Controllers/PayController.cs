...
namespace Paycompute.Controllers
{
    public class PayController : Controller
    {
        ...
        private readonly ISSNContributionService _sSNContributionService;
        ...
        public PayController(IPayComputationService payComputationService, IEmployeeService employeeService, ITaxService taxService, ISSNContributionService sSNContributionService)
        {
            _payComputationService = payComputationService;
            _employeeService = employeeService;
            _taxService = taxService;
            _sSNContributionService = sSNContributionService;
        }
        ...
        public async Task<IActionResult> Create(PaymentRecordCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var payrecord = new PaymentRecord()
                {
                    ...
                    SSN = _employeeService.GetById(model.EmployeeId).SSN,
                    ...
                    ContractualEarnings = contractualEarning = _payComputationService.ContractualEarnings(model.ContractualHours, model.HoursWorked, model.HourlyRate),
                    ...
                    TotalEarnings = totalEarnings = _payComputationService.TotalEarnings(overtimeEarnings, contractualEarning),
                    ...
                    SSNC = socialSecurity = _sSNContributionService.SSNContribution(totalEarnings),
                    TotalDeduction = totalDeduction = _payComputationService.TotalDeduction(tax, socialSecurity, studentLoan, unionFee),
